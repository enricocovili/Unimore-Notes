...
function instance2(s, r, o) {
  ...
  async function applySelected() {
    ...
    if (r && await w(r)) scheduleTask("update-plugin-list", 250, (() => k.updatePluginList(true, s.documentPath)));
  }
  s.$$set = s => {
  ...
  return [ L, D, C, T, I, A, x, R, B, applySelected, async function compareSelected() {
    const s = u.find((s => s.term == g)), r = u.find((s => s.term == C));
    if (s && r && await E(s, r)) scheduleTask("update-plugin-list", 250, (() => k.updatePluginList(true, s.documentPath)));
  }, async function deleteSelected() {
    const s = u.find((s => s.term == C));
    if (s && await S(s)) scheduleTask("update-plugin-list", 250, (() => k.reloadPluginList(true)));
...
var e, ObsidianLiveSyncSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    const b = s.createDiv(), w = b.createEl("h3", {
      ...
      text: ""
    }), S = "0.20.4", L = ~~(versionNumberString2Number(S) / 1e3), O = createSpan();
...
var LiveSyncLocalDB = class {
  ...
  async* findAllDocs(s) {
    const r = [ () => this.findEntries("_􏿿", "h:", null != s ? s : {}), () => this.findEntries("h:􏿿", "", null != s ? s : {}) ];
    for (const s of r) {
      const r = s();
  ...
  async* findAllDocNames(s) {
    const r = [ () => this.findEntryNames("_􏿿", "h:", null != s ? s : {}), () => this.findEntryNames("h:􏿿", "i:", null != s ? s : {}), () => this.findEntryNames("i:􏿿", "ix:", null != s ? s : {}), () => this.findEntryNames("ix:􏿿", "ps:", null != s ? s : {}), () => this.findEntryNames("ps:􏿿", "", null != s ? s : {}) ];
    for (const s of r) {
      const r = s();
  ...
  async* findAllNormalDocs(s) {
    const r = [ () => this.findEntries("_􏿿", "h:", null != s ? s : {}), () => this.findEntries("h:􏿿", "i:", null != s ? s : {}), () => this.findEntries("i:􏿿", "ix:", null != s ? s : {}), () => this.findEntries("ix:􏿿", "ps:", null != s ? s : {}), () => this.findEntries("ps:􏿿", "", null != s ? s : {}) ];
    for (const s of r) {
      const r = s();
